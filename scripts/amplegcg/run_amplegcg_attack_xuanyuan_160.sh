#!/bin/bash
# Run AmpleGCG attack on XuanYuan using shared 160-suffix pools
# Usage: nohup bash run_amplegcg_attack_xuanyuan_160.sh > ../../logs/amplegcg_attack_xuanyuan_160.log 2>&1 &
